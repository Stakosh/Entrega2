...
from sqlalchemy import Enum, Date, Integer, String
...
class Justificacion(db.Model):
    ...
    asignaturas = db.relationship('Enrollment', backref=db.backref('justificaciones', lazy=True))
